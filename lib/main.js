...
pageMod.PageMod({
	...
	contentScriptWhen: "start",
	contentStyle: [
		'.top_stories_content_wrapper, .FeedNavItem, .TopQuestionsForYou, .WriteNavItem, .HomeMainFeed, .HomeNavList, .TrendingTopicsNavList, .WritePageQuestionSidebar, .OnlineNowSidebar, .RelatedQuestions { display: none; }',
